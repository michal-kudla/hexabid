...
import com.github.hexabid.contract.api.InventoryApiDelegate;
import com.github.hexabid.contract.model.*;
import com.github.hexabid.product.*;
import com.github.hexabid.product.BatchId;
import com.github.hexabid.inventory.*;
...
public class RestInventoryApiDelegate implements InventoryApiDelegate {
    ...
    private InventoryInstanceResponse toInstanceResponse(Instance instance) {
        ...
        if (instance.maybeQuantity().isPresent()) {
            ...
            com.github.hexabid.contract.model.BatchResponseQuantity qty = 
                    new com.github.hexabid.contract.model.BatchResponseQuantity();

...
public final class ProductType implements Product {
    ...
    private final com.github.hexabid.quantity.Unit preferredUnit;
    ...
    ProductType(ProductIdentifier id,
                ...
                com.github.hexabid.quantity.Unit preferredUnit,
    ...
    public static ProductType define(ProductIdentifier id,
                                     ProductName name,
                                     ProductDescription description) {
        return new ProductType(id, name, description, com.github.hexabid.quantity.Unit.pieces(),
    ...
    public com.github.hexabid.quantity.Unit preferredUnit() {

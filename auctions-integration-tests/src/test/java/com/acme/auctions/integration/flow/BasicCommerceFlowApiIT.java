...
import com.acme.auctions.bootstrap.HexabidApplication;
...
@SpringBootTest(classes = HexabidApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
